...
namespace MisFinanzas.Migrations
{
    ...
    [Migration("20251126051627_AddLoanInstallmentsAndInterestRate")]
    partial class AddLoanInstallmentsAndInterestRate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MisFinanzas.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasIndex("UserId", "IsFixedExpense");
                    ...
                    b.ToTable("Categories", t =>
                        {
                            t.HasCheckConstraint("CK_Category_DayOfMonth", "\"DayOfMonth\" IS NULL OR (\"DayOfMonth\" >= 1 AND \"DayOfMonth\" <= 31)");
                        });
                });
