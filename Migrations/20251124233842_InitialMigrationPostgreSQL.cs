        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFixedExpense = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Category_DayOfMonth", "\"DayOfMonth\" IS NULL OR (\"DayOfMonth\" >= 1 AND \"DayOfMonth\" <= 31)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_UserId_IsFixedExpense",
                table: "Categories",
                columns: new[] { "UserId", "IsFixedExpense" });
