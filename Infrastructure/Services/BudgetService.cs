...

{
...

    {
...

        {
            ...
            var spentByCategory = await CalculateSpentByCategoryAsync(context, userId, month, year);
...

        {
            ...
            var categoriesWithBudget = await context.Budgets
            ...
            var expenses = await context.ExpensesIncomes
        ...
        private async Task<Dictionary<int, decimal>> CalculateSpentByCategoryAsync(ApplicationDbContext context, string userId, int month, int year)
